...
<footer class="footer">
    <nav class="footer-links-container">
        ...
        <ul class="footer-links">
            ...
            <li class="footer-links-a"><a href="?c=index&m=work_with_us#info">informacion</a></li>
        </ul>
        <ul class="footer-links">
            <li class="footer-links-title"><p>noticias</p></li>
            <li class="footer-links-a"><a href="?c=index&m=index">nuevas noticias</a></li>
            <li class="footer-links-a"><a href="?c=index&m=index&categoria=empleo">empleo</a></li>
            <li class="footer-links-a"><a href="?c=index&m=index&categoria=blog">blog</a></li>
        </ul>
        <ul class="footer-links">
    ...
    <div class="footer-info-container">
        <nav class="footer-social">
            <ul class="footer-social-ul">
                <li class="footer-social-li"><a href="https://www.linkedin.com/in/nicolas-azcoitia-12a004283/"><i class="fa-brands fa-linkedin"></i></a></li>
                <li class="footer-social-li"><a href="https://wa.me/59898033994"><i class="fa-brands fa-square-whatsapp"></i></a></li>
            </ul>
            <br>
            <p class="copyright-p">
                <i class="fa-solid fa-envelope"></i> <a href="mailto:clientes@antworkuy.com.uy" target="_blank" >clientes@antworkuy.com.uy</a>
            </p>
            <p class="copyright-p">
            <i class="fa-solid fa-location-dot"></i> <i>Manuel insua 5494 Montevideo</i>
            </p>
        </nav>
